...
import { createLandlordAction, type CreateLandlordState } from "./actions";

const initialState: CreateLandlordState = { error: null };

export function AddLandlordForm() {
  const [state, formAction, pending] = useActionState(createLandlordAction, initialState);
