...
import { createSecurityAction, type CreateSecurityState } from "./actions";

const initialState: CreateSecurityState = { error: null };

export function AddSecurityForm() {
  const [state, formAction, pending] = useActionState(createSecurityAction, initialState);
